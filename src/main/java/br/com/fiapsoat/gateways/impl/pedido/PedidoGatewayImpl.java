package br.com.fiapsoat.gateways.impl.pedido;
...
public class PedidoGatewayImpl implements PedidoGateway {
    ...
    private Pedido pedidoBuilder(TbPedido pedido){
        Pedido p = new Pedido();
                ...
                p.setCliente(clienteGateway.clienteBuilder(pedido.getCliente()));
                p.setProdutos(pedido.getProdutos().stream().map(produtoGateway::produtoBuilder).toList());
        return p;
    }
